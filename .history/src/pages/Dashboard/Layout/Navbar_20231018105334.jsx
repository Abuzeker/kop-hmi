...
import { Breadcrumb, Card, Col, Layout, Menu, Row, theme, Statistic, Collapse, Button } from 'antd';
      ...
      <div style={{ marginTop: '25px', marginBottom: '25px', padding: '0 50px' }}>
        <Row gutter={10}>
          <Col span={4}>
            <Card bordered={false}>
              <Statistic
                title={<span style={{ fontSize: '24px' }}>Custom Title</span>} // Set the font size of the title
                value={11.28}
                precision={2}
                valueStyle={{
                  color: '#3f8600',
